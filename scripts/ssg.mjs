#!/usr/bin/env node
/**
 * scripts/ssg.mjs — static-site-generator build step for the dafsa docs page.
 *
 * Pipeline:
 *
 ...
 *       injects the rendered markup into its `[data-mfe="dafsa-page"]` slot,
 ...
 * lets the `dafsa-page` MFE take over the pre-rendered DOM — see
...
const SLOT_SELECTOR = '[data-mfe="dafsa-page"]';
 ...
 * pre-rendered HTML of the dafsa docs page.
 */
 ...
 * `[data-mfe="dafsa-page"]` slot and return the final, complete HTML document.
 */
...
async function main() {
  ...
  log('rendering dafsa Elm page under happy-dom …');
